...
export default function LoginForm({ onSubmit, darkMode }: LoginFormProps) {
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            <label
              htmlFor="email"
              className={`${darkMode ? "text-gray-400" : "text-gray-600"} block text-sm font-medium mb-2`}
            >
              Email
            </label>
            <div className="relative">
              ...
              <input
                ...
                className={`${darkMode ? 
                  ...
                  w-full pl-10 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition-all`}
              />
            </div>
          </motion.div>
